...
type IUserRepository interface {
	...
	GetByPhoneNumber(phone string) (*core.User, error)
...
type IAccountRepository interface {
	...
	GetByUser(ctx context.Context, idUser string) (*core.Account, error)
...
type ICurrencyRepository interface {
	...
	GetByUser(ctx context.Context, idUser string) (*core.Currency, error)
