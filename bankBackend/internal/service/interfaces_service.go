...
type IAccountService interface {
	...
	Blocking(ctx context.Context, id int64) error
...
type ICardService interface {
	...
	GetByUser(ctx context.Context, userId int64) ([]core.Card, error)
...
type ICreditService interface {
	...
	GetByUser(ctx context.Context, userId int64) ([]core.Credit, error)
	...
	Repay(ctx context.Context, id int64, amount int) error
	Delete(ctx context.Context, id int64) error
}

type IDepositService interface {
	GetAll(ctx context.Context) ([]core.Deposit, error)
	GetByUser(ctx context.Context, userId int64) ([]core.Deposit, error)
	...
	Replenish(ctx context.Context, id int64, amount int) error
	Delete(ctx context.Context, id int64) error
}
...
type IExchangeRateService interface {
	GetAllRanking(ctx context.Context, currencyIdFrom int64) ([]core.ExchangeRate, error)
	GetRelativeRanking(ctx context.Context, currencyIdFrom int64, currencyIdTo int64) (*core.ExchangeRate, error)
}

type IConvertService interface {
	Convert(ctx context.Context, currencyIdFrom int64, amount int, currencyIdTo int64) (float64, error)
}
