...
require (
	github.com/Suinar/Bank-exhange-rate-service v0.0.0-20260717225001-087fd2b09d28
...
require (
	...
	github.com/kVinsom/Bank-proto v0.0.0-20260720230809-deff137c012a
	...
	golang.org/x/net v0.57.0 // indirect; indirectк
