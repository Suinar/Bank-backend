...
func TestCurrencyService_Success(t *testing.T) {
	...
	tests := []struct {
		...
		{name: "get by id", expect: func(m *fixture.CurrencyRepositoryMocks) {
			m.Currency.EXPECT().GetById(gomock.Any(), &common.IdRequest{Id: fixture.CurrencyId}).Return(fixture.CurrencyProto(), nil)
		}, invoke: func(s *CurrencyService) (any, error) { return s.GetById(context.Background(), fixture.CurrencyId) }, want: currencyCorePointer()},
		{name: "get by iso", expect: func(m *fixture.CurrencyRepositoryMocks) {
			m.Currency.EXPECT().GetByIso(gomock.Any(), &currencyRepository.IsoCodeRequest{IsoCode: fixture.CurrencyISOCode}).Return(fixture.CurrencyProto(), nil)
		...
		{name: "get by symbol", expect: func(m *fixture.CurrencyRepositoryMocks) {
			m.Currency.EXPECT().GetBySymbol(gomock.Any(), &currencyRepository.SymbolRequest{Symbol: string(fixture.CurrencySymbol)}).Return(fixture.CurrencyProto(), nil)
		}, invoke: func(s *CurrencyService) (any, error) {
		...
		{name: "delete", expect: func(m *fixture.CurrencyRepositoryMocks) {
			m.Currency.EXPECT().Delete(gomock.Any(), &common.IdRequest{Id: fixture.CurrencyId}).Return(&common.Empty{}, nil)
		}, invoke: func(s *CurrencyService) (any, error) { return nil, s.Delete(context.Background(), fixture.CurrencyId) }, want: nil},
	}
