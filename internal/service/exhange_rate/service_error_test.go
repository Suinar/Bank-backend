...
func TestExchangeRateService_InvalidDependenciesAndInput(t *testing.T) {
	...
	assertExchangeRateError(t, func() (any, error) { return missing.GetAllRanking(context.Background(), fixture.ExchangeISOFrom) }, coreErrors.InternalServerError)
	assertExchangeRateError(t, func() (any, error) {
		return missing.GetRelativeRanking(context.Background(), fixture.ExchangeISOFrom, fixture.ExchangeISOTo)
	...
	assertExchangeRateError(t, func() (any, error) { return sut.GetRelativeRanking(context.Background(), 0, fixture.ExchangeISOTo) }, coreErrors.BadRequest)
	assertExchangeRateError(t, func() (any, error) {
		return sut.GetRelativeRanking(context.Background(), fixture.ExchangeISOFrom, 1000)
...
func TestExchangeRateService_RepositoryErrors(t *testing.T) {
	...
	tests := []struct {
		...
		{name: "all bad request", expect: func(m *fixture.ExchangeRateRepositoryMocks) {
			...
			return s.GetAllRanking(context.Background(), fixture.ExchangeISOFrom)
		...
		{name: "relative bad request", expect: func(m *fixture.ExchangeRateRepositoryMocks) {
			...
			return s.GetRelativeRanking(context.Background(), fixture.ExchangeISOFrom, fixture.ExchangeISOTo)
		}, want: coreErrors.BadRequest},
